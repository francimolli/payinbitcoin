...
import { $ as $$FormattedDate } from './FormattedDate_BMA9Q_dE.mjs';
import 'clsx';
import { c as cn } from './BaseLayout_BJqM2-yA.mjs';
...
}, "/home/francis/Scrivania/blog-template/src/components/icons/ArrowUp.astro", void 0);
...
Leggi Post <span class="mt-[1px] group-hover:rotate-45 transition-transform duration-250 ease-in-out">${renderComponent($$result, "ArrowUp", $$ArrowUp, { "width": "18", "height": "18" })}</span> </a> </footer> </div> </article> `;
}, "/home/francis/Scrivania/blog-template/src/components/PostCard.astro", void 0);
...
}, "/home/francis/Scrivania/blog-template/src/components/ListPosts.astro", void 0);
