/* empty css                                     */
import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, e as renderComponent, F as Fragment, g as renderSlot, s as spreadAttributes, l as defineScriptVars } from '../../chunks/astro/server_H2LVesOC.mjs';
import 'kleur/colors';
import { s as siteConfig, g as getCollection } from '../../chunks/_astro_content_DKscRaPH.mjs';
import { $ as $$FormattedDate } from '../../chunks/FormattedDate_BMA9Q_dE.mjs';
import { $ as $$BaseLayout, c as cn, b as getPosts } from '../../chunks/BaseLayout_BJqM2-yA.mjs';
import 'clsx';
import { $ as $$Image } from '../../chunks/_astro_assets_CKu4AG-g.mjs';
import 'reading-time';
export { renderers } from '../../renderers.mjs';

const $$Astro$7 = createAstro("https://payinbitcoin.org/");
const $$Tag = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$7, $$props, $$slots);
  Astro2.self = $$Tag;
  const { tag } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(`/tags/${encodeURIComponent(tag.toLowerCase())}`, "href")}${addAttribute(tag, "aria-label")}> <span class="bg-green-600 font-semibold text-white dark:bg-green-800 dark:text-white shadow text-sm w-fit px-2 py-1 md:px-5 md:py-2 rounded-full"> ${tag ?? "Blog Tag"} </span> </a>`;
}, "/home/francis/Scrivania/blog-template/src/components/Tag.astro", void 0);

const $$Astro$6 = createAstro("https://payinbitcoin.org/");
...
Pubblicato ${renderComponent($$result2, "FormattedDate", $$FormattedDate, { "date": pubDate })} </p> <p class="text-center text-sm text-opacity-50 font-bold">
...
}, "/home/francis/Scrivania/blog-template/src/layouts/BlogPost.astro", void 0);
...
}, "/home/francis/Scrivania/blog-template/src/components/icons/CopyIcon.astro", void 0);
...
}, "/home/francis/Scrivania/blog-template/src/components/icons/CheckIcon.astro", void 0);
...
}, "/home/francis/Scrivania/blog-template/src/components/mdx/Code.astro", void 0);

const $$Astro$5 = createAstro("https://payinbitcoin.org/");
const $$ListRelatedPosts = createComponent(($$result, $$props, $$slots) => {
  ...
  }) : renderTemplate`<span class="text-gray-500">Non ci sono ancora post correlati. 😢</span>`} </section>`;
}, "/home/francis/Scrivania/blog-template/src/components/ListRelatedPosts.astro", void 0);

const $$TwitterColorIcon = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!--?xml version="1.0" ?-->${maybeRenderHead()}<svg height="32px" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;" version="1.1" viewBox="0 0 512 512" width="32px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M448,512l-384,0c-35.328,0 -64,-28.672 -64,-64l0,-384c0,-35.328 28.672,-64 64,-64l384,0c35.328,0 64,28.672 64,64l0,384c0,35.328 -28.672,64 -64,64Z" id="Dark_Blue" style="fill:#FF9900;fill-rule:nonzero;"></path><path d="M196.608,386.048c120.704,0 186.752,-100.096 186.752,-186.752c0,-2.816 0,-5.632 -0.128,-8.448c12.8,-9.216 23.936,-20.864 32.768,-34.048c-11.776,5.248 -24.448,8.704 -37.76,10.368c13.568,-8.064 23.936,-20.992 28.928,-36.352c-12.672,7.552 -26.752,12.928 -41.728,15.872c-12.032,-12.8 -29.056,-20.736 -47.872,-20.736c-36.224,0 -65.664,29.44 -65.664,65.664c0,5.12 0.64,10.112 1.664,14.976c-54.528,-2.688 -102.912,-28.928 -135.296,-68.608c-5.632,9.728 -8.832,20.992 -8.832,33.024c0,22.784 11.648,42.88 29.184,54.656c-10.752,-0.384 -20.864,-3.328 -29.696,-8.192l0,0.896c0,31.744 22.656,58.368 52.608,64.384c-5.504,1.536 -11.264,2.304 -17.28,2.304c-4.224,0 -8.32,-0.384 -12.288,-1.152c8.32,26.112 32.64,45.056 61.312,45.568c-22.528,17.664 -50.816,28.16 -81.536,28.16c-5.248,0 -10.496,-0.256 -15.616,-0.896c28.928,18.432 63.488,29.312 100.48,29.312" id="Logo__x2014__FIXED" style="fill:#fff;fill-rule:nonzero;"></path></g></svg>`;
}, "/home/francis/Scrivania/blog-template/src/components/icons/TwitterColorIcon.astro", void 0);

const $$LinkedinIcon = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<svg enable-background="new 0 0 32 32" height="32px" id="Layer_1" version="1.0" viewBox="0 0 32 32" width="32px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M32,30c0,1.104-0.896,2-2,2H2c-1.104,0-2-0.896-2-2V2c0-1.104,0.896-2,2-2h28c1.104,0,2,0.896,2,2V30z" fill="#FF9900"></path><g><rect fill="#FFFFFF" height="14" width="4" x="7" y="11"></rect><path d="M20.499,11c-2.791,0-3.271,1.018-3.499,2v-2h-4v14h4v-8c0-1.297,0.703-2,2-2c1.266,0,2,0.688,2,2v8h4v-7    C25,14,24.479,11,20.499,11z" fill="#FFFFFF"></path><circle cx="9" cy="8" fill="#FFFFFF" r="2"></circle></g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>`;
}, "/home/francis/Scrivania/blog-template/src/components/icons/linkedinIcon.astro", void 0);

const $$Astro$4 = createAstro("https://payinbitcoin.org/");
const $$Share = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$4, $$props, $$slots);
  Astro2.self = $$Share;
  const message = siteConfig.shareMessage;
  const URL = Astro2.url.href;
  return renderTemplate`${maybeRenderHead()}<div class="flex flex-col gap-2"> <span class="mb-1 font-bold text-2xl">orangepillare ₿</span> <ul class="flex gap-3 text-black dark:text-white"> <li> <a${addAttribute(`https://twitter.com/intent/tweet?text=${message + " " + URL}`, "href")} aria-label="Orangepillare su Twitter">${renderComponent($$result, "TwitterColorIcon", $$TwitterColorIcon, {})}</a> </li> <li> <a${addAttribute(`https://www.linkedin.com/shareArticle?mini=true&url=${URL}`, "href")} aria-label="Orangepillare su LinkedIn"> ${renderComponent($$result, "LinkedinIcon", $$LinkedinIcon, {})}</a> </li> </ul> </div>`;
}, "/home/francis/Scrivania/blog-template/src/components/Share.astro", void 0);

const $$Astro$3 = createAstro("https://payinbitcoin.org/");
...
}, "/home/francis/Scrivania/blog-template/src/components/TabletOfContentsHeading.astro", void 0);

const $$Astro$2 = createAstro("https://payinbitcoin.org/");
...
}, "/home/francis/Scrivania/blog-template/src/components/TableOfContents.astro", void 0);
...
}, "/home/francis/Scrivania/blog-template/src/components/mdx/SButton.astro", void 0);
...
}, "/home/francis/Scrivania/blog-template/src/components/Disqus.astro", void 0);
